...
-  The test with the studio is successfull locally with docker compose. But when it comes to the instance deployed as Cloud Run services, there's an issue with the connection to the [bridge endpoint](https://docs.novu.co/framework/endpoint).
